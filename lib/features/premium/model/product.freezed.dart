...
extension ProductPatterns on Product {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String title, String description, String currentPrice,
            int savePercent, String identifier, String? label)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Product() when $default != null:
        return $default(_that.title, _that.description, _that.currentPrice,
            _that.savePercent, _that.identifier, _that.label);
      case _:
        return orElse();
    }
  }
